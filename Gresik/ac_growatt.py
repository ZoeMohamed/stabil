...
class Ac_growatt():
            ...
            while self.Messagereceived != True:
                ...
                while True:
                    ...
                    if self.lowest_volt is not None:
                        ...
                        self.send_message(self.lowest_volt,self.topic,self.tool_status,self.full_message)
    ...
    def send_message(self,tegangan_listrik,topic,status,full_message):
        ...
        if(message.payload.decode('utf-8') == "Online" or message.payload.decode('utf-8') == "Offline"):
            ...
            if(len(self.comp_arr) == 2):
                if(abs(self.real_time_volt - self.last_volt)) >= 15:
                    ...
                    self.topics = topic
                    self.full_message = str(convertedDict)
